...
[4.3.7 视频编辑与受控生成：编辑遵循、内容保持与时空一致性](#4.3.7_视频编辑与受控生成：编辑遵循、内容保持与时空一致性)
  - [4.3.7.1 面试问题：视频编辑与 T2V、I2V 的本质区别是什么？](#4.3.7.1_面试问题：视频编辑与-T2V、I2V-的本质区别是什么？)
  - [4.3.7.2 面试问题：为什么视频编辑的核心是“修改与保持”的受约束生成？](#4.3.7.2_面试问题：为什么视频编辑的核心是“修改与保持”的受约束生成？)
  - [4.3.7.3 面试问题：视频编辑模型如何做到改对目标，同时尽量不误伤非编辑内容？](#4.3.7.3_面试问题：视频编辑模型如何做到改对目标，同时尽量不误伤非编辑内容？)
  - [4.3.7.4 面试问题：为什么局部编辑、编辑边界和多轮编辑容易引发时序不连续与内容漂移？](#4.3.7.4_面试问题：为什么局部编辑、编辑边界和多轮编辑容易引发时序不连续与内容漂移？)
  - [4.3.7.5 面试问题：如何判断一次视频编辑是否成功？编辑遵循、非编辑保持与时序连续应如何权衡？](#4.3.7.5_面试问题：如何判断一次视频编辑是否成功？编辑遵循、非编辑保持与时序连续应如何权衡？)
...
<h1 id="4.3.7_视频编辑与受控生成：编辑遵循、内容保持与时空一致性">4.3.7 视频编辑与受控生成：编辑遵循、内容保持与时空一致性</h1>

<h2 id="4.3.7.1_面试问题：视频编辑与-T2V、I2V-的本质区别是什么？">4.3.7.1 面试问题：视频编辑与 T2V、I2V 的本质区别是什么？</h2>

<h2 id="4.3.7.2_面试问题：为什么视频编辑的核心是“修改与保持”的受约束生成？">4.3.7.2 面试问题：为什么视频编辑的核心是“修改与保持”的受约束生成？</h2>

<h2 id="4.3.7.3_面试问题：视频编辑模型如何做到改对目标，同时尽量不误伤非编辑内容？">4.3.7.3 面试问题：视频编辑模型如何做到改对目标，同时尽量不误伤非编辑内容？</h2>

<h2 id="4.3.7.4_面试问题：为什么局部编辑、编辑边界和多轮编辑容易引发时序不连续与内容漂移？">4.3.7.4 面试问题：为什么局部编辑、编辑边界和多轮编辑容易引发时序不连续与内容漂移？</h2>

<h2 id="4.3.7.5_面试问题：如何判断一次视频编辑是否成功？编辑遵循、非编辑保持与时序连续应如何权衡？">4.3.7.5 面试问题：如何判断一次视频编辑是否成功？编辑遵循、非编辑保持与时序连续应如何权衡？</h2>
