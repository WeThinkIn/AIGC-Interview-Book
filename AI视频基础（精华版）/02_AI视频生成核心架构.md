...
文本、图像等条件通常先经过独立编码器转成条件特征，再注入视频生成主干，整体关系如图2-1所示。

<div align="center">
  <img src="./imgs/02_4.png" alt="多模态条件编码与视频生成主干关系示意图" width="720">
  <p>图2-1 多模态条件编码与视频生成主干关系示意图</p>
</div>
...
T5 和 CLIP 的架构与训练目标差异，可以分别参考图2-2和图2-3。

<div align="center">
  <img src="./imgs/02_1_t5.png" alt="T5 文本编码器架构示意图" width="720">
  <p>图2-2 T5 文本编码器架构示意图</p>
</div>

<div align="center">
  <img src="./imgs/02_2_clip.png" alt="CLIP 图文对齐架构示意图" width="720">
  <p>图2-3 CLIP 图文对齐架构示意图</p>
</div>

一些模型同时使用多种编码器，是因为视频生成需要同时“读懂语言”和“对齐视觉”。但多编码器会增加显存、延迟和条件融合复杂度。

T5 与 CLIP 在能力侧重点上的对比关系如图2-4所示。

<div align="center">
  <img src="./imgs/02_3.png" alt="T5 与 CLIP 条件能力对比示意图" width="720">
  <p>图2-4 T5 与 CLIP 条件能力对比示意图</p>
</div>
...
不同条件注入路径在视频生成主干中的位置关系，可以参考图2-5；其中 Cross-Attention 连接条件 token 与视频 token 的基本机制如图2-6所示。

<div align="center">
  <img src="./imgs/02_5.png" alt="多模态条件注入视频生成模型的方式示意图" width="760">
  <p>图2-5 多模态条件注入视频生成模型的方式示意图</p>
</div>

<div align="center">
  <img src="./imgs/02_6.png" alt="Cross-Attention 连接条件 token 与视频 token 的示意图" width="760">
  <p>图2-6 Cross-Attention 连接条件 token 与视频 token 的示意图</p>
</div>
...
从系统链路看，Video VAE 将像素视频压缩到 latent space，生成主干主要在 latent 中完成建模，再由解码器还原到视频像素空间，具体如图2-7所示。

<div align="center">
  <img src="./imgs/02_7_video_vae_pipeline.svg" alt="Video VAE latent pipeline" width="780">
  <p>图2-7 Video VAE 将像素视频压缩到 latent space 并解码回视频的流程示意图</p>
</div>
...
Image VAE 与 Video VAE 的核心区别在于压缩对象从单帧空间结构扩展为时空序列，具体如图2-8所示。

<div align="center">
  <img src="./imgs/02_8_image_vs_video_vae.svg" alt="Image VAE and Video VAE comparison" width="780">
  <p>图2-8 Image VAE 与 Video VAE 在压缩对象和建模目标上的差异示意图</p>
</div>
...
视频 latent 压缩率的设计，本质是在 token 成本、视觉细节、运动保真和下游生成稳定性之间寻找平衡点，具体如图2-9所示。

<div align="center">
  <img src="./imgs/02_9_latent_compression_tradeoff.svg" alt="Video latent compression trade-off" width="780">
  <p>图2-9 视频 latent 压缩率在 token 成本、信息损失与生成质量之间的权衡示意图</p>
</div>
