...
Stable Video Diffusion 论文中的 Camera Motion LoRA 示例可以辅助理解“同一条件帧 + 不同运动适配模块”带来的运动差异，如图3-2所示。

<div align="center">
  <img src="./imgs/03_paper_figures/03_svd_camera_motion_lora.jpeg" alt="Stable Video Diffusion Camera Motion LoRA" width="780">
  <p>图3-2 Stable Video Diffusion 中 Camera Motion LoRA 对同一条件帧施加不同相机运动的示意图</p>
</div>
...
SVD 论文中的样例进一步展示了视频基座模型在 T2V、I2V 和多视角生成等任务上的扩展性，如图3-3所示。
...
<div align="center">
  ...
  <p>图3-3 Stable Video Diffusion 在 T2V、I2V 与多视角生成任务上的样例</p>
</div>
