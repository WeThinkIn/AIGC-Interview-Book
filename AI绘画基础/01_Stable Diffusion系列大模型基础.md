...
- [3.介绍一下扩散模型中Classifier-Free Guidance和Classifier Guidance的原理，两者有哪些区别？](#3.介绍一下扩散模型中Classifier-Free-Guidance和Classifier-Guidance的原理，两者有哪些区别？)
- [4.介绍一下扩散模型中SDE的原理](#4.介绍一下扩散模型中SDE的原理)
- [5.介绍一下扩散模型中Rectified Flow的原理](#5.介绍一下扩散模型中Rectified-Flow的原理)
- [6.扩散模型有哪些常见的采样方式？介绍它们的原理](#6.扩散模型有哪些常见的采样方式？介绍它们的原理)
- [7.扩散模型和VAE、GAN之间有哪些联系和区别？](#7.扩散模型和VAE、GAN之间有哪些联系和区别？)
- [8.Stable Diffusion、Latent Diffusion以及Pixel Diffusion之间有哪些区别?](#8.Stable-Diffusion、Latent-Diffusion以及Pixel-Diffusion之间有哪些区别?)


## 第二章 Stable Diffusion 系列核心高频考点

- [1.介绍一下Stable Diffusion的原理](#1.介绍一下Stable-Diffusion的原理)
- [2.介绍一下Stable Diffusiuon中VAE的架构、原理和作用](#2.介绍一下Stable-Diffusiuon中VAE的架构、原理和作用)
- [3.介绍一下Stable Diffusiuon中Backbone的架构、原理和作用](#3.介绍一下Stable-Diffusiuon中Backbone的架构、原理和作用)
- [4.介绍一下Stable Diffusiuon中Text Encoder的架构、原理和作用](#4.介绍一下Stable-Diffusiuon中Text-Encoder的架构、原理和作用)
- [5.Stable Diffusiuon XL有哪些创新点？](#5.Stable-Diffusiuon-XL有哪些创新点？)
- [6.Stable Diffusiuon 3有哪些创新点？](#6.Stable-Diffusiuon-3有哪些创新点？)
- [7.面试中必考的AIGC图像创作/AI绘画技术脉络是什么样的？](#7.面试中必考的AIGC图像创作/AI绘画技术脉络是什么样的？)
...
<h2 id="3.介绍一下扩散模型中Classifier-Free-Guidance和Classifier-Guidance的原理，两者有哪些区别？">3.介绍一下扩散模型中Classifier-Free Guidance和Classifier Guidance的原理，两者有哪些区别？</h2>
...
<h2 id="5.介绍一下扩散模型中Rectified-Flow的原理">5.介绍一下扩散模型中Rectified Flow的原理</h2>
...
<h2 id="6.扩散模型有哪些常见的采样方式？介绍它们的原理">6.扩散模型有哪些常见的采样方式？介绍它们的原理</h2>
...
<h2 id="7.扩散模型和VAE、GAN之间有哪些联系和区别？">7.扩散模型和VAE、GAN之间有哪些联系和区别？</h2>
...
<h2 id="8.Stable-Diffusion、Latent-Diffusion以及Pixel-Diffusion之间有哪些区别?">8.Stable Diffusion、Latent Diffusion以及Pixel Diffusion之间有哪些区别?</h2>

### 面试问题：Latent Diffusion与Pixel Diffusion有哪些区别？

### 面试问题：Stable Diffusion与Latent Diffusion有哪些区别？
...
<h2 id="2.介绍一下Stable-Diffusiuon中VAE的架构、原理和作用">2.介绍一下Stable Diffusiuon中VAE的架构、原理和作用</h2>
...
<h2 id="4.介绍一下Stable-Diffusiuon中Text-Encoder的架构、原理和作用">4.介绍一下Stable Diffusiuon中Text Encoder的架构、原理和作用</h2>
...
<h2 id="7.面试中必考的AIGC图像创作/AI绘画技术脉络是什么样的？">7.面试中必考的AIGC图像创作/AI绘画技术脉络是什么样的？</h2>
