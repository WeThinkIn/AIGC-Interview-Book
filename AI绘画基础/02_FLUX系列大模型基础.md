...
- [1.介绍一下FLUX.1的原理，与Stable Diffusion 3相比有哪些创新点？](#1.介绍一下FLUX.1的原理，与Stable-Diffusion-3相比有哪些创新点？)
- [2.FLUX.1在训练过程中使用了哪些优化技巧？](#2.FLUX.1在训练过程中使用了哪些优化技巧？)
- [3.介绍一下FLUX.1 Lite与FLUX.1的异同](#3.介绍一下FLUX.1-Lite与FLUX.1的异同)
- [4.介绍一下FLUX.1 Kontext的原理，有哪些创新点？](#4.介绍一下FLUX.1-Kontext的原理，有哪些创新点？)
- [5.介绍一下FLUX.1 Krea的原理，有哪些创新点？](#5.介绍一下FLUX.1-Krea的原理，有哪些创新点？)


## 第二章 FLUX.2系列核心高频考点

- [1.与FLUX.1相比，FLUX.2有哪些创新点？](#1.与FLUX.1相比，FLUX.2有哪些创新点？)
...
<h2 id="1.介绍一下FLUX.1的原理，与Stable-Diffusion-3相比有哪些创新点？">1.介绍一下FLUX.1的原理，与Stable Diffusion 3相比有哪些创新点？</h2>
...
<h2 id="2.FLUX.1在训练过程中使用了哪些优化技巧？">2.FLUX.1在训练过程中使用了哪些优化技巧？</h2>

### 面试问题：FLUX.1模型的微调训练流程一般包含哪几部分核心内容？


### 面试问题：FLUX.1模型的微调训练流程中有哪些关键参数？


<h2 id="3.介绍一下FLUX.1-Lite与FLUX.1的异同">3.介绍一下FLUX.1-Lite与FLUX.1的异同</h2>


<h2 id="4.介绍一下FLUX.1-Kontext的原理，有哪些创新点？">4.介绍一下FLUX.1 Kontext的原理，有哪些创新点？</h2>

### 面试问题：介绍一下FLUX.1 Kontext的原理，FLUX.1 Kontext能够执行哪些AIGC任务？


<h2 id="5.介绍一下FLUX.1-Krea的原理，有哪些创新点？">5.介绍一下FLUX.1 Krea的原理，有哪些创新点？</h2>

### 面试问题：介绍一下FLUX.1 Krea的训练策略


### 面试问题：介绍一下FLUX.1-Krea中监督微调（SFT）的流程
...
### 面试问题：FLUX.1 Krea的后训练过程中有哪些关键要点？
...
### 面试问题：介绍一下FLUX.1 Krea的后训练过程中使用的Tuned Preference Optimization技术
...
<h2 id="1.与FLUX.1相比，FLUX.2有哪些创新点？">1.与FLUX.1相比，FLUX.2有哪些新特性与优化亮点？与FLUX.1相比，FLUX.2有哪些创新点？</h2>
