...
- [1.AIGC图像生成大模型的完整训练过程都包含哪些阶段？](#1.AIGC图像生成大模型的完整训练过程都包含哪些阶段？)
- [2.AIGC图像生成领域主流的数据标注范式有哪些?](#2.AIGC图像生成领域主流的数据标注范式有哪些?)
- [3.AIGC图像生成领域主流的微调训练方法有哪些?](#3.AIGC图像生成领域主流的微调训练方法有哪些?)
- [4.介绍一下AIGC图像生成大模型的对齐训练原理](#4.介绍一下AIGC图像生成大模型的对齐训练原理)
- [5.介绍一下AIGC图像生成大模型的常用加速方法](#5.介绍一下AIGC图像生成大模型的常用加速方法)

---

<h2 id="1.AIGC图像生成大模型的完整训练过程都包含哪些阶段？">1.AIGC图像生成大模型的完整训练过程都包含哪些阶段？ </h2>
...
### 面试问题：Seedream的三阶段训练Pipeline都包含了哪些内容？
...
<h2 id="2.AIGC图像生成领域主流的数据标注范式有哪些?">2.AIGC图像生成领域主流的数据标注范式有哪些? </h2>


<h2 id="3.AIGC图像生成领域主流的微调训练方法有哪些?">3.AIGC图像生成领域主流的微调训练方法有哪些? </h2>


### 面试问题：介绍一下图像生成领域的SFT训练的过程


### 面试问题：介绍一下图像生成领域的RLHF训练的过程


### 面试问题：介绍一下OFT(Orthogonal Finetuning)微调技术
...
<h2 id="4.介绍一下AIGC图像生成大模型的对齐训练原理">4.介绍一下AIGC图像生成大模型的对齐训练原理 </h2>
...
<h2 id="5.介绍一下AIGC图像生成大模型的常用加速方法">5.介绍一下AIGC图像生成大模型的常用加速方法</h2>
...
### 面试问题：介绍一下OneDiff加速技术的原理


### 面试问题：介绍一下SVDQuant量化技术的原理


### 面试问题：介绍一下xfomers加速技术的原理


### 面试问题：介绍一下Token Merging加速技术的原理


### 面试问题：介绍一下TeaCache加速技术的原理


### 面试问题：介绍一下wavespeed加速技术的原理
